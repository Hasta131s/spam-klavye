...
private val LightColorScheme = DarkColorScheme // Always maintain sophisticated dark vibe!

@Composable
fun MyApplicationTheme(
  darkTheme: Boolean = isSystemInDarkTheme(),
  // Dynamic color is disabled by default for precise custom theme representation
